...
# Описание структуры ответа для получения токенов (логин)
...
# Описание структуры ответа для обновления токена
...
# Описание структуры ответа для верификации токена
...
# Описание структуры ответа для логаута (блэклист токенов)
